// ============================================================
// LLM provider 抽象（四段式 · 第 2 段的基础设施）
// 从 apps/resume-screening/src/llm/providers.ts 泛化而来，原样通用。
// 双实现：Anthropic 官方 SDK / Volcengine Ark（OpenAI 兼容端点）。
// 环境变量 LLM_PROVIDER=anthropic|ark 切换，默认 ark。
// 新增 provider：实现 LlmProvider 接口 + 在 getProvider() 加分支。
// ============================================================
...
class AnthropicProvider implements LlmProvider {
  private client = new Anthropic(); // 读 ANTHROPIC_API_KEY
